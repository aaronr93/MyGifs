//
//  GfyCollectionViewLayout.swift
//  MyGifs
//
//  Created by Aaron Rosenberger on 12/27/17.
    ...
    override func prepare() {
        ...
        for section in 0 ..< numberOfSections {
            ...
            if (headerHeight > 0) {
                ...
                let attributes = UICollectionViewLayoutAttributes(forCellWith: IndexPath(row: 0, section: section))
